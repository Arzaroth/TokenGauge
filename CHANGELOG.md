...
- **The Omarchy panel had no refresh button.** Refreshing it meant knowing
  that `r` or a right-click on the bar icon does it - Plasma, GNOME and the
  tray have all had a visible control. The panel header now carries one beside
  the history and settings icons, dimmed while a fetch is in flight.
...
[Unreleased]: https://github.com/Arzaroth/TokenGauge/compare/v0.32.0...HEAD
