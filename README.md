...
- **Pace tracking**: each usage window shows whether you're burning quota faster (`+8%`, deficit) or slower (`-3%`, reserve) than an even-consumption rate, with a projected run-out - shown in the Waybar tooltip, TUI, and popover
