...
function box(vertical: boolean, props: Partial<St.BoxLayout.ConstructorProps> = {}): St.BoxLayout {
...
function label(text: string, styleClass: string, style?: string): St.Label {
...
function attachTooltip<T extends St.Widget>(
